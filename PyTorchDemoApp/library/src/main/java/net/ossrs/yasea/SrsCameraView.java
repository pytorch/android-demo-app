...
public class SrsCameraView extends GLSurfaceView implements GLSurfaceView.Renderer {
    ...
    private Camera.Size best_size;  // Instance variable


    public Camera.Size get_best_size()
    {
        if(mCamera==null)
            return null;
    ...
    public void onSurfaceChanged(GL10 gl, int width, int height) {
        ...
        System.out.println("in srscameraview display size changed to w:"+width+", h:"+height);
        magicFilter.onInputSizeChanged(mPreviewWidth, mPreviewHeight);
    ...
    private Camera.Size adaptPreviewResolution(Camera.Size resolution) {
        ...
        System.out.println("best size is h:" + best.height + " w:" + best.width);
        return best;
    }
