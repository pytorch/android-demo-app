package com.github.faucamp.simplertmp_1.amf;
...
public class AmfString implements AmfData {
    ...
    public void writeTo(OutputStream out) throws IOException {
        ...
        FaucampUtil.writeUnsignedInt16(out, byteValue.length);
        // Write string
        out.write(byteValue);
    }
    ...
    public void readFrom(InputStream in) throws IOException {
        ...
        int length = FaucampUtil.readUnsignedInt16(in);
        size = 3 + length; // 1 + 2 + length
        // Read string value
        byte[] byteValue = new byte[length];
        FaucampUtil.readBytesUntilFull(in, byteValue);
