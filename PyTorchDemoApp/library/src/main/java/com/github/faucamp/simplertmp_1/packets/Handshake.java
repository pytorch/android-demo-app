...
import com.github.faucamp.simplertmp_1.FaucampCrypto;
...
//        out.write(new byte[]{(byte) 0x80, 0x00, 0x07, 0x02}); // Bytes 4 - 7: Flash player version: 11.2.202.233
        ...
        Log.d(TAG, "writeC1(): digestOffsetBytes: " + FaucampUtil.toHexString(digestOffsetBytes));  //Util.unsignedInt32ToByteArray((digestOffset % 728))));
        ...
        byte[] timeStamp = FaucampUtil.unsignedInt32ToByteArray((int) (System.currentTimeMillis() / 1000));
...
//        }
        ...
        FaucampCrypto crypto = new FaucampCrypto();
